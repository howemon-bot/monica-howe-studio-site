...
const projects: Project[] = [
  {
    ...
    gallery: [
      { kind: 'shot', shot: { src: bcHero, alt: 'Be Casa identity on tropical foliage' } },
      {
        kind: 'pair',
        shots: [
          { src: bcManual, alt: 'Be Casa brand manual cover' },
  ...
  },
  {
    ...
    gallery: [
      ...
      { kind: 'shot', shot: { src: medBook1, alt: 'Medinaceli brand manual covers' } },
      {
        kind: 'grid',
        shots: [
          { src: medBook2, alt: 'Medinaceli brand book interior' },
          { src: medBook3, alt: 'Medinaceli brand book interior' },
          { src: medBook4, alt: 'Medinaceli brand book interior' },
          { src: medBook5, alt: 'Medinaceli brand book interior' },
        ],
      },
      {
        kind: 'shot',
  ...
  },
  {
    ...
    gallery: [
      { kind: 'shot', shot: { src: telaviGuide, alt: 'Telavi brand guidelines' } },
      {
        kind: 'grid',
        shots: [
          { src: telaviIllu2, alt: 'Telavi illustration — working from the sofa' },
  ...
  },
  {
    ...
    gallery: [
      ...
      },
      {
        kind: 'pair',
        shots: [
          { src: fleaBag1, alt: 'The Tiny Flea tote bag' },
          {
            src: fleaBottle1,
  ...
  },
  {
    ...
    gallery: [
      { kind: 'shot', shot: { src: wcCards, alt: 'Worldcoo business cards' } },
      {
        kind: 'pair',
        shots: [
